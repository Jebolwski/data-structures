...
listptr mergelist(listptr l1, listptr l2)
{
    if (l1->bas == NULL)
    {
        return l2;
    ...
    listptr tmp = l1;
    listptr l3 = (listptr)malloc(sizeof(listptr));
    l3->bas = tmp->bas;
    l3->son = l2->son;
    tmp->son->ileri = l2->bas;
    return l3;
}
...
int main()
{
    ...
    listptr list2 = newList();
    addtoHead(list2, newNode(1));
    addtoEnd(list2, newNode(2));
    addtoEnd(list2, newNode(3));
    addtoHead(list2, newNode(4));
    printList(list);
    printList(list2);
    listptr list3 = mergelist(list, list2);
    printList(list3);
}